...
# SWITCH THIS TO FALSE IF YOU DON'T HAVE OLLAMA INSTALLED
USE_AI = False
...
def get_extra_content(company_name:str, extra_considerations:str) -> str:
    if not USE_AI:
        print(f"AI Usage disabled, please type your own personalized message to {company_name}")
        print(f"Keep in mind these considerations: {extra_considerations}")
        response = input()
        return response
...
def main():
    print(get_extra_content("Veritas Technologies", ""))
