...
SYSTEM_PROMPT = f"""You are the Outreach Director for a student club at
            your university.
            ...
            Example 3:
            Our members enjoyed the Hilton GBM back in spring, and we would like to invite Hilton again this fall. 
            This will provide a good opportunity for our members to learn more about how tech is reshaping the hospitality industry 
            and provide valuable networking opportunities. We would love to have a representative speak at one of our General Body Meetings and give their insights!
            """
...
def create_body_text(c: MessageContent, extra_content:str) -> str:
    ...
    <p><span style="font-family: Georgia, serif; font-size: 12pt;">[ORGANIZATION]</p>
